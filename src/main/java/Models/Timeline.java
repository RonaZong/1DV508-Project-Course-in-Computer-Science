...
public class Timeline {
    ...
    public Timeline(String title, String description, String timeUnit, Date startDate, Date endDate, User createdBy) {
        this.title = title;
    ...
    public void editTimeline(String title, String description, String timeUnit, Date startDate, Date endDate, User createdBy) {
        this.title = title;
        this.description = description;
        this.timeUnit = timeUnit;
        this.startDate = startDate;
