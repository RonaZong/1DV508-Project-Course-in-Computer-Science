        ...
        selectFileButton.setOnAction(actionEvent -> {
				...
				if (selectedFile != null) {
		            try {
		                ...
		                profileImage.setImage(image); // ImageView now working!
  ...
  /*  public void fileChooser() throws FileNotFoundException {
    ...
    public void createAccount() throws IOException {
    	...
    	// create user
    		...
    		user.setImage(FileController.getAbsolutePath(selectedFile));
    ...
    public void editAccount() throws IOException {
    	...
    	FileController.moveFileToDir(selectedFile);
    	getCurrentUser().setImage(FileController.getAbsolutePath(selectedFile));
